    ...
    <div class="mx-auto max-w-6xl px-4 py-10 md:px-6">
        <div class="rounded-[32px] border border-[rgba(201,168,76,0.18)] bg-[linear-gradient(160deg,rgba(10,22,40,0.98)_0%,rgba(13,31,60,0.95)_60%,rgba(26,48,96,0.9)_100%)] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.28)] md:p-8">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                <a href="{{ route('public.articles.index') }}" class="rounded-full border border-[rgba(201,168,76,0.3)] px-4 py-2 text-sm font-bold text-white/75 transition hover:bg-white/5">Artikel Edukasi</a>
                <a href="{{ route('public.videos.index') }}" class="rounded-full px-4 py-2 text-sm font-bold transition bg-[linear-gradient(135deg,#c9a84c,#f0c060)] text-[#0a1628]">Video Edukasi</a>
            </div>
