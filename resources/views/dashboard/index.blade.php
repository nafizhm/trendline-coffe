...
@section('content')
    ...
    <div class="grid gap-5 lg:grid-cols-3">
        <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm leading-7 text-slate-600">Sidebar sekarang dibuat sederhana supaya mudah ditambah modul baru nanti.</p>
        </div>
        <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <p class="text-sm font-semibold text-slate-500">Navigasi</p>
            <p class="mt-3 text-xl font-bold text-slate-900">Sidebar bisa di-toggle</p>
            <p class="mt-2 text-sm leading-7 text-slate-600">Tombol di topbar bisa menutup atau membuka sidebar untuk desktop dan mobile.</p>
        </div>
        <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <p class="text-sm font-semibold text-slate-500">Pengembangan</p>
