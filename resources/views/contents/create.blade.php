...
@section('content')
    <div class="space-y-6">
        <section class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <h2 class="mt-2 text-3xl font-black text-slate-900">Tambah Konten</h2>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Tambahkan data konten baru dengan editor teks agar penulisan isi konten lebih nyaman.</p>
                </div>
        ...
        <form action="{{ route('contents.store') }}" method="POST" class="space-y-6" data-loading-form>
            @csrf
